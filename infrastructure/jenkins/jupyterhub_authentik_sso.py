...
def main():
    ...
    # jupyterhub
    jupyterhub_reference = variables["jupyterhub_reference"]
    jupyterhub_state = get_resources_state(jupyterhub_reference)["data"]
    jupyterhub_domain = jupyterhub_state["State"]["ovh_domain_zone_record"]["values"]
    jupyterhub_domain = concatenate_domain(
        sub_domain=jupyterhub_domain["subdomain"],
        root_domain=jupyterhub_domain["zone"],
    )

    body = {
        "ref": jupyterhub_reference,
        "platform": {
            "name": "jupyterhub",
            "metadata": {
                "jupyterhub_url": "https://%s" % jupyterhub_domain,
