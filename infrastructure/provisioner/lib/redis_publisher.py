...
def main(channel: str, message: str, no_encode: bool):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--noencode", required=False, default=False, type=bool)
    args = parser.parse_args()

    logging.info(args)

    main(channel=args.channel, message=args.message, no_encode=args.noencode)
